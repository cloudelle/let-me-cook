...
<template>
  <nav class="border-gray-200 dark:bg-gray-900">
    <div class="min-h-20 max-w-screen-xl flex flex-wrap items-center justify-between mx-auto font-sans">

      <router-link to="/" active-class="text-tomato"
            exact-active-class="text-teal-400">
            <div class="flex-shrink-0">
              <img src="../../images/let-me-cook-logo.png" alt="Logo" class="h-20" /><div class="font-merienda font-bold">Let Me COOK!</div>
            </div> 
      ...
      <!-- <div class="hidden w-full md:block md:w-auto mx-auto" id="navbar-default"> -->
        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 rounded-lg md:flex-row lg:space-x-20 md:space-x-12 sm:space-x-1 md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <li v-if="!isLoggedIn">
